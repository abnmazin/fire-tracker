...
const initialUsers = [
  ...
  { id: 2, name: 'الوالد (المشرف العام)', username: 'father', password: '123', role: 'father', archived: false },
...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => { unsubExt(); unsubUsers(); unsubLogs(); unsubContacts(); unsubLocs(); unsubPolicies(); };
  }, [fbUser, appId]);
      ...
      <div className="bg-gradient-to-l from-amber-50 to-white border border-amber-200 rounded-2xl p-5 md:p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-2">واجهة مستقلة ومركزية بدون تكرار أزرار لكل موقع.</p>
          </div>
...
// 10. إعدادات المطور
function DeveloperSettings({ locations, setLocations, contacts, auditLogs, setAuditLogs, extinguishers, setExtinguishers, users, setUsers, db, fbUser, appId, logAction, currentUser }) {
